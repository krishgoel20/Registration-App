# Registration-App
+ A Registration App is a Web or Mobile Application designed to streamline the process of User Registration and Sign-up. 
...
+ This will open a new tab in the web browser with the **Expo DevTools**. 
...
+ Integrate **MongoDB** to store user registration data as follows :
    ...
    + **Implement Database Operations** - Implement functions or methods to perform CRUD Operation (Create, Read, Update, Delete) in the app : 
...
## File Structure
### 1. node_modules
+ This directory contains all the dependencies and packages that the project relies on. 
+ It is managed by **Node Package Manager (npm)** or **Yarn**.

### 2. public
+ This is a directory where various assets and resources are stored, which are publicly accessible within the app. 
+ In this case, a folder called **images** has been created inside this directory, containing the **background** image and the **logo** icon for the app.
...
+ The **App.js** file is the entry point and the backbone of the app. It is the main component that sets up the navigation and renders the app's structure.
